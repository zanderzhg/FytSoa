...
if (typeof jQuery === "undefined") {
    ...
    defaultLayoutTemplates = {
        ...
        iframeTabPane: '<iframe id="{tabPaneId}" class="tab-pane {class}"  width="100%" height="100%" frameborder="0" onreadystatechange="stateChangeIE(this)" onload="stateChangeFirefox(this)" src="" seamless></iframe>'
    };
    ...
    MultiTabs.prototype = {
        ...
        _getNavTabHtml : function (param) {
            ...
            //alert(param.url + "------------" + param.id + "-----------" + param.id);
            ...
            if(options.draggable){
                handler($el.navPanelList, 'mousedown', '.mt-nav-tab', function (event) {
                    ...
                    $navTabLi.css({'left': event.pageX - abs_x + 'px', 'position': 'absolute', 'z-index': 9999})
                        ...
                        .find('a:first').css({'background' : '#ffffff'});
    ...
    $.fn.multitabs.defaults = {
        ...
        navBar : {
            ...
            backgroundColor : '#ffffff',            //default nav-bar background color
        },
        ajaxTabPane : {
        ...
        language : {                                //language setting
            navBar : {
                ...
                showActivedTab : '<i class="fa fa-refresh"></i>刷新当前',          //show active tab
                closeAllTabs : '<i class="fa fa-close"></i>关闭所有',                //close all tabs
                closeOtherTabs : '<i class="fa fa-power-off"></i>关闭其他',            //close other tabs
            }
        },
